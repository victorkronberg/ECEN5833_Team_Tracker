...
{
0x92, 0x9d, 0x7b, 0x25, 0xa5, 0x16, 0x26, 0x90, 0xd5, 0x46, 0x3f, 0xd7, 0xf0, 0x05, 0x13, 0xfc, 
0xcb, 0xf2, 0xf6, 0xe4, 0x8a, 0x75, 0x2d, 0xb5, 0x07, 0x48, 0x94, 0x96, 0x39, 0xf1, 0x4c, 0x66, 
0xcd, 0xe3, 0x17, 0x22, 0xa7, 0x8f, 0xb6, 0xa0, 0x9a, 0x42, 0x4c, 0x99, 0x64, 0xf3, 0xc0, 0x82, 
0x3b, 0xe9, 0x1d, 0xaf, 0xb3, 0x2a, 0x23, 0xbe, 0x08, 0x43, 0xe6, 0x9c, 0xc0, 0xa4, 0xfe, 0xfb, 
0x3f, 0xce, 0xcb, 0x97, 0xf3, 0x11, 0xf5, 0x92, 0xff, 0x4a, 0x32, 0xe0, 0x1c, 0x69, 0x57, 0xe0, 
...
uint8_t bg_gattdb_data_attribute_field_53_data[4]={0x00,0x00,0x00,0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_50 ) = {
	.len=5,
	.data={0x02,0x34,0x00,0x21,0x2a,}
};
uint8_t bg_gattdb_data_attribute_field_48_data[17]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_45 ) = {
	.len=5,
	.data={0x02,0x2f,0x00,0x1d,0x2a,}
};
uint8_t bg_gattdb_data_attribute_field_43_data[17]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_29 ) = {
	.len=5,
	.data={0x02,0x1f,0x00,0x01,0x2a,}
};
uint8_t bg_gattdb_data_attribute_field_28_data[13]={0x45,0x6d,0x70,0x74,0x79,0x20,0x45,0x78,0x61,0x6d,0x70,0x6c,0x65,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_27 ) = {
	.len=5,
	.data={0x0a,0x1d,0x00,0x00,0x2a,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_26 ) = {
	.len=2,
	.data={0x00,0x18,}
};
uint8_t bg_gattdb_data_attribute_field_24_data[2]={0x00,0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_20 ) = {
	.len=5,
	.data={0x32,0x16,0x00,0x6d,0x2a,}
};
uint8_t bg_gattdb_data_attribute_field_19_data[1]={0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_18 ) = {
	.len=19,
	.data={0x02,0x14,0x00,0x3f,0xce,0xcb,0x97,0xf3,0x11,0xf5,0x92,0xff,0x4a,0x32,0xe0,0x1c,0x69,0x57,0xe0,}
};
uint8_t bg_gattdb_data_attribute_field_16_data[1]={0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_15 ) = {
	.len=19,
	.data={0x30,0x11,0x00,0x3b,0xe9,0x1d,0xaf,0xb3,0x2a,0x23,0xbe,0x08,0x43,0xe6,0x9c,0xc0,0xa4,0xfe,0xfb,}
};
uint8_t bg_gattdb_data_attribute_field_13_data[1]={0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_12 ) = {
	.len=19,
	.data={0x30,0x0e,0x00,0xcd,0xe3,0x17,0x22,0xa7,0x8f,0xb6,0xa0,0x9a,0x42,0x4c,0x99,0x64,0xf3,0xc0,0x82,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_9 ) = {
	.len=19,
	.data={0x30,0x0b,0x00,0xcb,0xf2,0xf6,0xe4,0x8a,0x75,0x2d,0xb5,0x07,0x48,0x94,0x96,0x39,0xf1,0x4c,0x66,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_8 ) = {
	.len=16,
	.data={0x92,0x9d,0x7b,0x25,0xa5,0x16,0x26,0x90,0xd5,0x46,0x3f,0xd7,0xf0,0x05,0x13,0xfc,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8001,.permissions=0x800,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_10},
    {.uuid=0x000e,.permissions=0x807,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x03,.index=0x03,.clientconfig_index=0x01}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_12},
    {.uuid=0x8002,.permissions=0x800,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_13},
    {.uuid=0x000e,.permissions=0x807,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x03,.index=0x04,.clientconfig_index=0x02}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_15},
    {.uuid=0x8003,.permissions=0x800,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_16},
    {.uuid=0x000e,.permissions=0x807,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x03,.index=0x05,.clientconfig_index=0x03}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_18},
    {.uuid=0x8004,.permissions=0x801,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_19},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_20},
    {.uuid=0x0003,.permissions=0x801,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_21},
    {.uuid=0x000e,.permissions=0x807,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x03,.index=0x07,.clientconfig_index=0x04}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_23},
    {.uuid=0x0004,.permissions=0x800,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_24},
    {.uuid=0x000e,.permissions=0x807,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x02,.index=0x08,.clientconfig_index=0x05}},
    ...
    {.uuid=0x0006,.permissions=0x803,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_28},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_29},
    {.uuid=0x0007,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_30},
    ...
    {.uuid=0x0009,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_33},
    ...
    {.uuid=0x000b,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_37},
    ...
    {.uuid=0x8006,.permissions=0x802,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_40},
    ...
    {.uuid=0x000d,.permissions=0x800,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_43},
    {.uuid=0x000e,.permissions=0x803,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x02,.index=0x0b,.clientconfig_index=0x06}},
    ...
    {.uuid=0x0010,.permissions=0x800,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_48},
    {.uuid=0x000e,.permissions=0x803,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x0d,.clientconfig_index=0x07}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_50},
    {.uuid=0x0011,.permissions=0x801,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_51},
    {.uuid=0x000e,.permissions=0x803,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x0e,.clientconfig_index=0x08}},
    {.uuid=0x0012,.permissions=0x801,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_53},
};
